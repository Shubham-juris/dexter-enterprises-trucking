  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-12 pb-6 mt-20">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Reliable and efficient trucking solutions across the nation. On-time
            delivery with safety and professionalism at every mile.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2">
            ...
            <li>
              <a href="#fleet" className="hover:text-blue-500 transition">
                Fleet
              </a>
            </li>
            <li>
      ...
      <div className="border-t border-gray-700 mt-10 pt-6 text-center text-sm">
        ...
        <span className="text-white font-medium">Dexter Trucking</span>. All
        rights reserved.
      </div>
    </footer>
  );
