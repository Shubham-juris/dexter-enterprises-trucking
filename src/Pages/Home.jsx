...
import vidio from "../assets/video/vidio.mp4";
const Home = () => {
  return (
    <div className="bg-gray-50 text-gray-800">
      ...
      <section id="about" className="py-20 px-6 max-w-6xl mx-auto text-center">
        ...
        >
          ...
          freight services across North America.
        </motion.p>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {[
            ...
            <motion.div
              ...
              className="bg-gray-100 rounded-2xl p-6 text-center shadow-md hover:shadow-lg"
            >
